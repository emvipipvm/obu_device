...
#include "task.h"
#include "semphr.h"
extern void OBU_INIT_create(void);
extern TaskHandle_t OBU_INIT;
extern void OBU_GNSS_create(void);
extern TaskHandle_t OBU_GNSS;
extern void OBU_MQTT_create(void);
extern TaskHandle_t OBU_MQTT;
extern void OBU_RECONNECT_create(void);
extern TaskHandle_t OBU_RECONNECT;
extern void OBU_LCD_create(void);
